---
title: "2072022_analysis"
author: "Tanvi Ingle"
date: "2/7/2022"
output: html_document
---
## **READ THIS**
This analysis resuses the first phix174_optimization_1; ie the algorithm that still sets the first generation error to e^10 AND declares and error as -1 if not all 11 genes are expressed. **Thus, this analysis is incomplete.**
...
basedir <- "/stor/work/Wilke/tingle/phix174/output/2072022/"
...
### **Objective**
Here I will analyze the results from the promoter optimization run on 2-7-2022. For this optimization attempt, I ran 5 scenarios with unique distributions for promoters A, B, and D. Each scenario was simmulated 10 times. Each simulation was run for 300 generations. 
...
scenario_B_best <- plot_grid(sim2, sim5, sim6, sim9, sim10, ncol = 3)
...
plot_grid(sim2_time, sim5_time, nrow = 2)
