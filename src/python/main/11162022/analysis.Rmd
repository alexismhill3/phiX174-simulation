...
my_palette = c("#d0a34f", "#75c130", "#c12c04", "#ecd575", "#b69507", "#e37c71", "#adcb40", "#d3ad40", "#288ede", "#a5bdfa", "#93c9ff")
#my_palette = c("#A6CEE3", "#1F78B4", "#B2DF8A", "#33A02C", "#FFFF99", "#E31A1C", "#FDBF6F", "#FF7F00", "#CAB2D6", "#6A3D9A", "#999999")
...
```
```{r}
best_gen_report %>% ggplot(aes(x= final_min_error, y = fct_reorder(as.character(sim), final_min_error, .desc=TRUE))) +
  geom_point() +
  geom_vline(xintercept = 2.75, linetype="dotted") +
  scale_y_discrete(name = "Model") +
  scale_x_continuous(name = "Final RMSE") +
  theme_classic() +
  panel_border()
ggsave("paper_figures/qPCR_rmses.png", width = 8, height = 4)
```
