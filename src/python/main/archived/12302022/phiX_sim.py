""" Simulates phix174 gene expression with predicted cryptic promoter (btss49) and terminator (RUT3). For testing purposes, these sites are parameterized with arbitrary values. """
...
def run_pt(sim, gen, pA, pB, pD, btss49, tJ, tF, tG, tH, RUT3, base_dir, output_folder):
    ...
    model.simulate(time_limit=500, time_step=5,output=output_folder + "/" + "sim_" + sim + "_gen_" + str(gen) + ".tsv")
...
if __name__ == "__main__":
    ...
    tH = 0.9807020
    RUT3 = 0.5
    run_pt(sim, gen, pA, pB, pD, btss49, tJ, tF, tG, tH, RUT3, base_dir, output_folder)
