...
# STEP 4:
def main(u, o, o_prom, o_term, pA, date, sim, base_dir):
    gen = 0
    ...
    while (gen < 2000):
        ...
        if (rX == "pA"): # leaving this uncommented, but should never be true since pA was removed from params
...
if __name__ == '__main__':
    ...
    pA = float(sys.argv[8])
    main(u, o, o_prom, o_term, pA, date, sim, base_dir)
