...
- Ran 20 trials for **2000** iterations each
...
logel_timeseries_with_pcr(filedir, sim_num, "0", "435", best_gen, time_stamp)
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "235", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
```{r}
sim_num <- "10"
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "883", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
