...
#### Summary
- Held promoter A strength constant at 12x10^6
- Using S.D. 0.1 for the promoter step distribution, and 0.05 for terminators
- No longer using a fixed seed for individual simulations
- Ran 20 trials for 1000 iterations each
...
get_single_reports <- function(filedir, sim){
...
logel_timeseries_with_pcr(filedir, sim_num, "0", "257", best_gen, time_stamp)
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "265", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
```{r}
sim_num <- "9"
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "13", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
```{r}
sim_num <- "20"
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "78", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "639", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```