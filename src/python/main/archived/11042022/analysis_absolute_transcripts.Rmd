...
#### Summary
- Fitting to absolute transcript counts. 
...
logel_timeseries_with_pcr(filedir, sim_num, "0", "776", best_gen, time_stamp)
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "624", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
```{r}
sim_num <- "14"
...
get_single_report(filedir, sim_num)
logel_timeseries_with_pcr(filedir, sim_num, "0", "342", best_gen, time_stamp)
transcripts_vs_time_plot(filedir, sim_num, best_gen)
```
