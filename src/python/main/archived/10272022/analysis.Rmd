...
logel_timeseries_with_pcr(filedir, sim_num, "0", "250", best_gen, time_stamp)
```
...
logel_timeseries_with_pcr(filedir, sim_num, "0", "100", best_gen, time_stamp)
```
...
logel_timeseries_with_pcr(filedir, sim_num, "0", "20", best_gen, time_stamp)
```
