...
def run_pt(pA, pB, pD, tJ, tF, tG, tH, time, output_folder):
    ...
    genomic_coords = pd.read_csv("/stor/scratch/Wilke/amh7958/phix174-simulation/data/" + "genomic_coords.csv")
    ...
    model.simulate(time_limit=int(time), time_step=5,output=output_folder + "/sim_" + sim + "_time_" + str(time) + ".tsv")
...
if __name__ == "__main__":
    ...
    tG = 0.5370027
    tH = 0.9807020
    run_pt(pA, pB, pD, tJ, tF, tG, tH, time, output_folder)
