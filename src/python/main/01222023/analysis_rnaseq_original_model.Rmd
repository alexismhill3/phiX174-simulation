...
#### Summary
Fit original regulatory model (3 promoters & 4 terminators) to higher resolution RNA-seq data
...
```
```{r}
write_csv(best_gen_report, "best_gen_report_rnaseq_original.csv")
```
