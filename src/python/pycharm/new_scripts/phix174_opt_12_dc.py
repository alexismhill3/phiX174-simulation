...
def main(sim, gen, pA, pB, pD, tJ, tF, tG, tH, base_dir, genomic_coords_path, date):
    ...
    # Run simulation
    model.simulate(time_limit=1200, time_step=5,output=base_dir + "output/" + str(date) + "/wildtype/sim_" + str(sim) + "_gen_" + str(gen) + ".tsv")
...
if __name__ == '__main__':
    ...
    date = sys.argv[12]
    main(sim, gen, pA, pB, pD, tJ, tF, tG, tH, base_dir, genomic_coords_path, date)
