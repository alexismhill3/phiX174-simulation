...
### **Other Code Snippets**
These are snippets borrowed from the code I used to make the figures in my thesis. I did not write pretty wrapper functions to create these...

The file paths for the output files should be redirected to: Wilke/tingle/phix174/output/4152022. The most relevant snippet is probably the Fitness Bar Plots. 
